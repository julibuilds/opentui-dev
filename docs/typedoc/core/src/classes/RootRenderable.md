...
[opentui-dev](../../../README.md) / [core/src](../README.md) / RootRenderable

# Class: RootRenderable
...
Typically created once per application and passed to [CliRenderer](CliRenderer.md).
...
> **new RootRenderable**(`ctx`): `RootRenderable`
