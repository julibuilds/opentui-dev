...
[opentui-dev](../../../README.md) / [core/src](../README.md) / ArrowRenderable
...
> **new ArrowRenderable**(`ctx`, `options`): `ArrowRenderable`
...
> **get** **direction**(): `"right"` \| `"left"` \| `"down"` \| `"up"`
...
> **get** **foregroundColor**(): [`RGBA`](RGBA.md)
...
> **set** **foregroundColor**(`value`): `void`
