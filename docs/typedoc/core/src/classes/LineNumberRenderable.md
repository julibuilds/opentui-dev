...
[opentui-dev](../../../README.md) / [core/src](../README.md) / LineNumberRenderable

# Class: LineNumberRenderable
...
> **new LineNumberRenderable**(`ctx`, `options`): `LineNumberRenderable`
...
> **getLineSigns**(): `Map`\<`number`, [`LineSign`](../interfaces/LineSign.md)\>

Gets the current map of line signs.

#### Returns

`Map`\<`number`, [`LineSign`](../interfaces/LineSign.md)\>
