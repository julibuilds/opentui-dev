...
[opentui-dev](../../../README.md) / [core/src](../README.md) / FrameBufferRenderable
...
FrameBufferRenderable provides an [OptimizedBuffer](OptimizedBuffer.md) that can be drawn to independently
...
- [`ASCIIFontRenderable`](ASCIIFontRenderable.md)

## Constructors

### Constructor

> **new FrameBufferRenderable**(`ctx`, `options`): `FrameBufferRenderable`
