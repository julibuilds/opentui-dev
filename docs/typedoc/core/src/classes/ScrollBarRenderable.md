...
[opentui-dev](../../../README.md) / [core/src](../README.md) / ScrollBarRenderable
...
- Integrated [SliderRenderable](SliderRenderable.md) for thumb dragging
...
> **new ScrollBarRenderable**(`ctx`, `__namedParameters`): `ScrollBarRenderable`
...
> `readonly` **endArrow**: [`ArrowRenderable`](ArrowRenderable.md)
...
> `readonly` **slider**: [`SliderRenderable`](SliderRenderable.md)

***

### startArrow

> `readonly` **startArrow**: [`ArrowRenderable`](ArrowRenderable.md)
...
> **set** **arrowOptions**(`options`): `void`

##### Parameters

###### options

`Omit`\<[`ArrowOptions`](../interfaces/ArrowOptions.md), `"direction"`\>
...
> **set** **trackOptions**(`options`): `void`

##### Parameters

###### options

`Partial`\<[`SliderOptions`](../interfaces/SliderOptions.md)\>
