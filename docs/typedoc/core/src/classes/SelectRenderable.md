...
[opentui-dev](../../../README.md) / [core/src](../README.md) / SelectRenderable

# Class: SelectRenderable
...
> **new SelectRenderable**(`ctx`, `options`): `SelectRenderable`
...
> **descriptionColor**: `string` = `"#888888"`

#### fastScrollStep

> **fastScrollStep**: `number` = `5`
...
> **selectedBackgroundColor**: `string` = `"#334455"`

#### selectedDescriptionColor

> **selectedDescriptionColor**: `string` = `"#CCCCCC"`
...
> **selectedTextColor**: `string` = `"#FFFF00"`
...
> **showScrollIndicator**: `false` = `false`
...
> **set** **descriptionColor**(`value`): `void`
...
> **get** **options**(): [`SelectOption`](../interfaces/SelectOption.md)[]
...
> **set** **selectedBackgroundColor**(`value`): `void`
...
> **set** **selectedDescriptionColor**(`value`): `void`
...
> **set** **selectedTextColor**(`value`): `void`
...
> **set** **showScrollIndicator**(`show`): `void`
...
> **getSelectedOption**(): [`SelectOption`](../interfaces/SelectOption.md)
