...
[opentui-dev](../../../README.md) / [core/src](../README.md) / TabSelectRenderable
...
> **new TabSelectRenderable**(`ctx`, `options`): `TabSelectRenderable`
...
> **set** **focusedBackgroundColor**(`color`): `void`
...
> **set** **focusedTextColor**(`color`): `void`
...
> **get** **options**(): [`TabSelectOption`](../interfaces/TabSelectOption.md)[]
...
> **set** **selectedBackgroundColor**(`color`): `void`
...
> **set** **selectedDescriptionColor**(`color`): `void`
...
> **set** **selectedTextColor**(`color`): `void`
...
> **set** **showScrollArrows**(`show`): `void`
...
> **getSelectedOption**(): [`TabSelectOption`](../interfaces/TabSelectOption.md)
