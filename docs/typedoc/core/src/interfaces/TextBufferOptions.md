...
[opentui-dev](../../../README.md) / [core/src](../README.md) / TextBufferOptions

# Interface: TextBufferOptions

Configuration options for [TextBufferRenderable](../classes/TextBufferRenderable.md).

## Extends

- [`RenderableOptions`](RenderableOptions.md)\<[`TextBufferRenderable`](../classes/TextBufferRenderable.md)\>
