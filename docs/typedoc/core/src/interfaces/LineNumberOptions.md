...
[opentui-dev](../../../README.md) / [core/src](../README.md) / LineNumberOptions

# Interface: LineNumberOptions

Configuration options for [LineNumberRenderable](../classes/LineNumberRenderable.md).

## Extends

- [`RenderableOptions`](RenderableOptions.md)\<[`LineNumberRenderable`](../classes/LineNumberRenderable.md)\>
...
> `optional` **lineSigns**: `Map`\<`number`, [`LineSign`](LineSign.md)\>
...
Minimum width of the line number column in characters.
...
Right padding after line numbers.
...
> `optional` **target**: [`Renderable`](../classes/Renderable.md) & [`LineInfoProvider`](LineInfoProvider.md)
