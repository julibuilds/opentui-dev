...
[opentui-dev](../../../README.md) / [core/src](../README.md) / VRenderableOptions

# Interface: VRenderableOptions
...
- [`RenderableOptions`](RenderableOptions.md)\<[`VRenderable`](../classes/VRenderable.md)\>
...
> `optional` **render**: (`this`, `buffer`, `deltaTime`, `renderable`) => `void`

#### Parameters

##### this

`VRenderableOptions` | [`VRenderable`](../classes/VRenderable.md)
