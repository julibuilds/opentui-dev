...
[opentui-dev](../../../README.md) / [core/src](../README.md) / FrameBufferOptions

# Interface: FrameBufferOptions

Configuration options for [FrameBufferRenderable](../classes/FrameBufferRenderable.md).

## Extends

- [`RenderableOptions`](RenderableOptions.md)\<[`FrameBufferRenderable`](../classes/FrameBufferRenderable.md)\>
