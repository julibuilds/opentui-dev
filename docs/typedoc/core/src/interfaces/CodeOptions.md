...
[opentui-dev](../../../README.md) / [core/src](../README.md) / CodeOptions

# Interface: CodeOptions

Configuration options for [CodeRenderable](../classes/CodeRenderable.md).
...
[`TextOptions`](TextOptions.md).[`bg`](TextOptions.md#bg)
...
> `optional` **drawUnstyledText**: `boolean`
...
[`TextOptions`](TextOptions.md).[`fg`](TextOptions.md#fg)
...
[`TextBufferOptions`](TextBufferOptions.md).[`opacity`](TextBufferOptions.md#opacity)
...
[`TextOptions`](TextOptions.md).[`selectionBg`](TextOptions.md#selectionbg)
...
[`TextOptions`](TextOptions.md).[`selectionFg`](TextOptions.md#selectionfg)
...
> **syntaxStyle**: [`SyntaxStyle`](../classes/SyntaxStyle.md)
...
[`TextOptions`](TextOptions.md).[`tabIndicator`](TextOptions.md#tabindicator)
...
[`TextOptions`](TextOptions.md).[`tabIndicatorColor`](TextOptions.md#tabindicatorcolor)
...
[`TextOptions`](TextOptions.md).[`wrapMode`](TextOptions.md#wrapmode)
