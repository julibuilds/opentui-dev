...
[opentui-dev](../../../README.md) / [core/src](../README.md) / InputRenderableOptions
...
- [`RenderableOptions`](RenderableOptions.md)\<[`InputRenderable`](../classes/InputRenderable.md)\>
...
> `optional` **placeholderColor**: [`ColorInput`](../type-aliases/ColorInput.md)
