...
[opentui-dev](../../../README.md) / [core/src](../README.md) / ASCIIFontOptions

# Interface: ASCIIFontOptions

Configuration options for [ASCIIFontRenderable](../classes/ASCIIFontRenderable.md).

## Extends

- `Omit`\<[`RenderableOptions`](RenderableOptions.md)\<[`ASCIIFontRenderable`](../classes/ASCIIFontRenderable.md)\>, `"width"` \| `"height"`\>
...
> `optional` **color**: [`ColorInput`](../type-aliases/ColorInput.md) \| [`ColorInput`](../type-aliases/ColorInput.md)[]
...
> `optional` **font**: [`ASCIIFontName`](../type-aliases/ASCIIFontName.md)

The ASCII art font to use.
...
> `optional` **selectionBg**: [`ColorInput`](../type-aliases/ColorInput.md)
...
> `optional` **selectionFg**: [`ColorInput`](../type-aliases/ColorInput.md)
